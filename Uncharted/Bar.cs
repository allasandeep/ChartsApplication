 ...
 *																										           *
 *  Date Due  : November 29, 2018			File :	Bar.cs     					     				           *                          
 *																										           *
...
namespace Uncharted
{
    public partial class Bar : Form
    {
		...
		private void Bar_Load(object sender, EventArgs e)
		{
			...
			barChart.ChartAreas["ChartArea1"].AxisX.Title = "Employee";
			barChart.ChartAreas["ChartArea1"].AxisY.Title = "Dollars($)";
			...
			foreach (var x in Form1.barChartData)
			{
				...
				barChart.Series["Salary"].Points.AddXY(result[0],result[1]);
			}
		}

		//Method that is executed on closing the form
		private void Bar_FormClosing_1(object sender, FormClosingEventArgs e)
		{
