namespace Uncharted
{
    partial class Pie
    {
        ...
        private void InitializeComponent()
        {
			...
			this.Name = "Pie";
			this.Text = "Pie";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.Pie_FormClosing_1);
